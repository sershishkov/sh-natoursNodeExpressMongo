...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1Ijoic2Vyc2hpc2hrb3YiLCJhIjoiY2szYWV2MzI4MGJ0ejNlbXg4bG5oN295NyJ9.jlSysXJkGdd0cXabXiuXDw';
  ...
  return regeneratorRuntime.async(function logout$(_context2) {
    while (1) {
      switch (_context2.prev = _context2.next) {
        ...
        case 3:
          res = _context2.sent;
          if (res.data.status === 'success') location.reload(true); // console.log(res);
...
var logiOutBtn = document.querySelector('.nav__el--logout');
